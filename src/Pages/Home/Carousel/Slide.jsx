...
const Slide = ({img,offerSticker,flowerSticker}) => {
    return (
        <div className='lg:flex relative bg-gradient h-[550px] pt-6 lg:pt-0'>
                    ...
                    <img className='w-32 lg:w-40 h-32 lg:h-40 absolute -right-3 lg:-right-10   bottom-16 lg:bottom-0 lg:-px-4 pr-3 lg:pr-0  lg:rotate-45 ' src={offerSticker} alt="" />
                    <img className=' w-20 h-20  absolute -right-4   pr-8 lg:pt-6 rotate-120   lg:mt-4   ' src={flowerSticker} alt="" />
